...
export default function ReportsPage() {
  ...
  return (
    <div className="flex-1 space-y-8 p-4 sm:p-8 pt-6 bg-gray-50/30" dir="rtl">
      ...
      <section className="bg-gradient-to-br from-[#1E6E2F] via-[#35AB4E] to-[#8DD09B] rounded-[32px] p-8 sm:p-10 text-white shadow-2xl shadow-green-900/10 overflow-hidden relative border-0">
