...
export default function StudentLayout({
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Desktop Sidebar - Hidden on tablets and iPad Pro to prevent cramped layout */}
      <div className="hidden xl:block w-[280px] flex-shrink-0 m-4">
         <Sidebar />
      </div>

      {/* Mobile Header logic is inside ConditionalHeader or we can place it here */}
      
      <main className="flex-1 w-full transition-all duration-200 pt-0 px-4 md:px-8 py-8 overflow-x-hidden xl:w-[calc(100%-280px)]" >
