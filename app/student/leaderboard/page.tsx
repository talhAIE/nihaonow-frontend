                            ...
                            {topThree.length >= 1 && (
                                <>
                                    ...
                                    {topThree[2] && (
                                        <div className="flex flex-col items-center">
                                            <div className="relative mb-2">
                                                <div className="h-20 w-20 lg:h-32 lg:w-32 rounded-full bg-white border-4 border-amber-300 flex items-center justify-center">
                                                    <div className="h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-amber-100 flex items-center justify-center">
                                                        <span className="text-2xl lg:text-4xl font-bold text-amber-700">
                                                            {topThree[2].username?.charAt(0).toUpperCase() || '?'}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div className="absolute -top-1.5 -right-1.5 h-6 w-6 lg:h-10 lg:w-10 lg:-top-2 lg:-right-2 flex items-center justify-center rounded-full bg-amber-500 text-sm lg:text-xl font-bold text-white shadow-md">
                                                    3
                                                </div>
                                            </div>
                                            <h4 className="text-sm lg:text-lg font-bold text-gray-800 mb-1 truncate w-full text-center">{topThree[2].username || '-'}</h4>
                                            <p className="text-xs lg:text-sm text-amber-600 font-semibold mb-1">{topThree[2].score?.toFixed(1) || 0} نقطة</p>
                                            <p className="text-xs lg:text-sm text-gray-700">{topThree[2].metrics?.topicsCompleted || 0} موضوع</p>
                                        </div>
                                    )}
                                    ...
                                    {topThree[1] && (
                                        <div className="flex flex-col items-center">
                                            <div className="relative mb-2">
                                                <div className="h-20 w-20 lg:h-32 lg:w-32 rounded-full bg-white border-4 border-[#35AB4E] flex items-center justify-center">
                                                    <div className="h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-gray-100 flex items-center justify-center">
                                                        <span className="text-2xl lg:text-4xl font-bold text-gray-700">
                                                            {topThree[1].username?.charAt(0).toUpperCase() || '?'}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div className="absolute -top-1.5 -right-1.5 h-6 w-6 lg:h-10 lg:w-10 lg:-top-2 lg:-right-2 flex items-center justify-center rounded-full bg-[#35AB4E] text-sm lg:text-xl font-bold text-white shadow-md">
                                                    2
                                                </div>
                                            </div>
                                            <h4 className="text-sm lg:text-lg font-bold text-gray-800 mb-1 truncate w-full text-center">{topThree[1].username || '-'}</h4>
                                            <p className="text-xs lg:text-sm text-[#35AB4E] font-semibold mb-1">{topThree[1].score?.toFixed(1) || 0} نقطة</p>
                                            <p className="text-xs lg:text-sm text-gray-700">{topThree[1].metrics?.topicsCompleted || 0} موضوع</p>
                                        </div>
                                    )}
                                    ...
                                    {topThree[0] && (
                                        <div className="flex flex-col items-center">
                                            <div className="relative mb-2">
                                                <div className="h-20 w-20 lg:h-32 lg:w-32 rounded-full bg-white border-4 border-yellow-400 flex items-center justify-center">
                                                    <div className="h-16 w-16 lg:h-24 lg:w-24 rounded-full bg-yellow-100 flex items-center justify-center">
                                                        <span className="text-2xl lg:text-4xl font-bold text-yellow-700">
                                                            {topThree[0].username?.charAt(0).toUpperCase() || '?'}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div className="absolute -top-1.5 -right-1.5 h-6 w-6 lg:h-10 lg:w-10 lg:-top-2 lg:-right-2 flex items-center justify-center rounded-full bg-yellow-500 text-sm lg:text-xl font-bold text-white shadow-md">
                                                    1
                                                </div>
                                            </div>
                                            <h4 className="text-sm lg:text-lg font-bold text-gray-800 mb-1 truncate w-full text-center">{topThree[0].username || '-'}</h4>
                                            <p className="text-xs lg:text-sm text-yellow-600 font-semibold mb-1">{topThree[0].score?.toFixed(1) || 0} نقطة</p>
                                            <p className="text-xs lg:text-sm text-gray-700">{topThree[0].metrics?.topicsCompleted || 0} موضوع</p>
                                        </div>
                                    )}
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-right">
                                                <div className="text-base font-medium text-gray-800">
                                                    <span className="truncate block max-w-[120px] sm:max-w-[150px]">{entry.username || '-'}</span>
                                                </div>
