...
import { teacherApi } from '@/lib/services/teacher'; // Use teacherApi instead of dashboardApi
        ...
        <div className="space-y-6" dir="rtl">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="bg-[#D6F0E0] rounded-[20px] p-4 flex flex-col items-center justify-center aspect-square md:aspect-auto md:h-32 transition-transform hover:scale-[1.02]">
                    ...
                    <span className="text-[#2D9344] text-3xl font-black font-nunito">{stats.totalStudents}</span>
                </div>
                ...
                <div className="bg-[#FFF8E1] rounded-[20px] p-4 flex flex-col items-center justify-center aspect-square md:aspect-auto md:h-32 transition-transform hover:scale-[1.02]">
                    ...
                    <span className="text-[#D9A51F] text-3xl font-black font-nunito">{stats.totalTopics}</span>
                </div>
                ...
                <div className="bg-[#FFEEDA] rounded-[20px] p-4 flex flex-col items-center justify-center aspect-square md:aspect-auto md:h-32 transition-transform hover:scale-[1.02] relative overflow-hidden">
                    ...
                    <div className="relative w-auto h-auto flex items-center justify-center">
                        <span className="text-[#E38B29] text-2xl font-black font-nunito">{stats.overallUsage}</span>
                ...
                <div className="bg-[#FBD4D3] rounded-[20px] p-4 flex flex-col items-center justify-center aspect-square md:aspect-auto md:h-32 transition-transform hover:scale-[1.02]">
                    ...
                    <span className="text-[#BC313F] text-lg font-black font-nunito text-center">{stats.mostUsedMode || "عام"}</span>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-6">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="text-center group">
                            ...
                            <div className="text-2xl font-black text-slate-800 font-nunito">{stats.loggedInCount}</div>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <div className="text-2xl font-black text-slate-800 font-nunito">{stats.notLoggedInCount}</div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        {filteredStudents.length === 0 ? (
                            ...
                            filteredStudents.map((student) => (
                                <div key={student.id} className="group bg-white border border-slate-50 rounded-[20px] p-4 flex flex-col md:flex-row items-center justify-between hover:shadow-lg hover:shadow-slate-100 transition-all duration-300 gap-4 w-full">
                                    ...
                                    <div className="hidden md:flex flex-col items-center md:items-start w-full md:w-1/3">
                                        ...
                                        <p className="font-black text-slate-700 font-nunito text-base">{student.totalPoints?.toLocaleString()}</p>
                                    </div>

                                    {/* Actions */}
                                    <div className="w-full md:w-1/3 flex justify-end">
                                        <Link href={`/teacher/reports/view?studentId=${student.id}`}>
                                            <button className="flex flex-row items-center gap-1.5 px-4 py-2 bg-white border border-slate-100 rounded-xl text-slate-700 text-xs font-black hover:bg-slate-50 transition-all">
                                                <span>منظر</span>
