...
export default function StudentReportContent() {
  ...
  return (
    <div className="bg-white min-h-screen p-8 font-sans" dir="rtl">
      {/* Header */}
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-[#D6F0E0] rounded-2xl p-4 flex items-center justify-center gap-3">
                <span className="font-bold text-[#2D9344] text-sm font-nunito">{report.totalPoints}</span>
        ...
        <div className="bg-[#FFF8E1] rounded-3xl p-6 flex items-center justify-center divide-x divide-orange-200/50 divide-x-reverse">
             <div className="flex-1 flex flex-col items-center px-4">
                ...
                <div className="text-3xl font-black text-slate-800 font-nunito">{report.currentStreak} <span className="text-xs text-slate-400 font-bold">أيام</span></div>
             </div>
             ...
             <div className="flex-1 flex flex-col items-center px-4">
                ...
                <div className="text-3xl font-black text-slate-800 font-nunito">{report.longestStreak} <span className="text-xs text-slate-400 font-bold">أيام</span></div>
             </div>
        </div>

        {/* Monthly Stats - White Card */}
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-50">
            <h3 className="text-center font-bold text-slate-500 mb-8 font-nunito">يناير 2026</h3>
            <div className="space-y-4 max-w-sm mx-auto">
                ...
                {skills.map((skill, i) => (
                    <div key={i} className="flex justify-between items-center px-4">
                         <span className="font-bold text-slate-600 text-sm font-nunito">{skill.score.toFixed(1)}</span>
                ...
                <div className="flex justify-between items-center px-4 pt-4 mt-2">
                    <span className="font-bold text-[#35AB4E] text-sm font-nunito">{totalScore.toFixed(1)}</span>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-50">
            ...
            <div className="flex justify-between items-end mb-2">
                ...
                <span className="font-black text-slate-800 text-xs font-nunito">{lectureProgress}%</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#fcebeb] rounded-xl p-6 flex flex-col items-center justify-center text-center">
                        <span className="font-black text-slate-800 font-nunito text-2xl mb-1">{report.completedTopics}</span>
                ...
                <div className="bg-[#ecf7ed] rounded-xl p-6 flex flex-col items-center justify-center text-center">
                        <span className="font-black text-slate-800 font-nunito text-2xl mb-1">{remainingTopics}</span>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-50 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
                {(report.rewards && report.rewards.length > 0 ? report.rewards : [1,2,3,4,5]).map((_, i) => ( // Use mock rewards if none to show layout
